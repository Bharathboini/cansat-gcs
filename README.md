...
> **Note:** This dashboard currently runs on simulated telemetry data 
> generated by a mathematical flight model. In a real CanSat mission, 
> the data source would be replaced with live radio telemetry from actual onboard sensors.
